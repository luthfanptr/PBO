package Praktikum.Sesi11.LatihanSoal.Soal3;
...
class Notebook extends Komputer {
    @Override
    public void hidupkan_os() {
        System.out.println("Notebook: OS dihidupkan");
    }

    @Override
    public void matikan_os() {
        System.out.println("Notebook: OS dimatikan");
    }

    @Override
    public void klik_kanan() {
        System.out.println("Notebook: Klik kanan dengan mouse");
    }

    @Override
    public void klik_kiri() {
        System.out.println("Notebook: Klik kiri dengan mouse");
    }

    @Override
    public void tekan_enter() {
        System.out.println("Notebook: Tombol enter ditekan");
    }

    @Override
    public void cetak_data() {
        System.out.println("Notebook: Data dicetak dengan printer");
    }
}
